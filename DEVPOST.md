...
- **AR glasses** — overlay the expert skeleton directly in the user's field of view
- **Multi-camera 3D** — depth-aware coaching and more reliable fall detection
- **Clinical PT dashboards** — export ROM data, rep counts, and progress to clinicians
- **Hospital scale** — ceiling-mounted cameras replacing $50-100k/year patient sitters
- **Personalized models** — fine-tuned to individual body proportions and injury history
